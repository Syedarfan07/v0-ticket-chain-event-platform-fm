...
import { Ticket, Mail, Lock, Wallet, ArrowLeft, Eye, EyeOff, LayoutDashboard } from "lucide-react"
      ...
      <div className="flex flex-1 flex-col justify-center px-6 py-12 md:px-12 lg:px-20">
        ...
        <div className="mx-auto w-full max-w-sm">
          ...
          <p className="mb-8 text-sm text-muted-foreground">
            Manage your events, track sales, and coordinate your team
          </p>
      ...
      <div className="hidden flex-1 flex-col items-center justify-center bg-card/50 px-6 py-12 md:px-12 lg:flex lg:px-20">
        <div className="mx-auto w-full max-w-sm text-center">
          ...
          <p className="mb-8 text-sm leading-relaxed text-muted-foreground">
            Link your organizer wallet to deploy smart contracts and receive ticket revenue.
          </p>
